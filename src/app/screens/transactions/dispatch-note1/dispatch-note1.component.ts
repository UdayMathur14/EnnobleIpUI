...
@Component({
  selector: 'app-dispatch-note1',
  templateUrl: './dispatch-note1.component.html',
  styleUrls: ['./dispatch-note1.component.scss'],
  providers: [DatePipe],
})
export class DispatchNoteComponent1 {
  ...
  onCreateDispatchNote() {
    this.router.navigate(['transaction/addEditVendorInvoice1/0']);
  }

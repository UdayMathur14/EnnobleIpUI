...
@Component({
  selector: 'app-processed-report-grid-table',
  templateUrl: './processed-report-grid-table.component.html',
  styleUrl: './processed-report-grid-table.component.scss'
})
export class ProcessedReportGridTableComponent {

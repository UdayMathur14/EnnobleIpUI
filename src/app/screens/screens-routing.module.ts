...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: "report/OutStandingvendorPayment", component: ProvisionalReportComponent, canActivate: [] },
            { path: "report/vendorpurchase", component: RejectionBiltiDetailReportComponent, canActivate: [] },
            { path: "report/vendorsearch", component: ErrorLoggingReportComponent, canActivate: [] },
            { path: "report/pendingSaleInvoices", component: DebitNoteReportComponent, canActivate: [] },
            { path: "report/OutStandingvendorPayment", component: ProvisionReportComponent, canActivate: [] },

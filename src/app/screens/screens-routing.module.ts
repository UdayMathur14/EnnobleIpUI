...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: "transaction/dispatchNote", component: DispatchNoteComponent, canActivate: [] },
            { path: "transaction/addEditDispatchNote", component: AddEditDispatchNoteComponent, canActivate: [] },
            { path: "transaction/addEditDispatchNote/:dispatchId", component: AddEditDispatchNoteComponent, canActivate: [] },
            { path: "transaction/addEditDispatchNote/:locationId/:dispatchId", component: AddEditDispatchNoteComponent, canActivate: [] },
